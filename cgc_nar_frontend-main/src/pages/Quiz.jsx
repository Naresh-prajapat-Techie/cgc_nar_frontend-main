    ...
    `}</style>
      ...
      <div className="antialiased container mx-auto p-4 sm:p-6 lg:p-8 max-w-5xl">
        <header className="text-center mb-8">
          ...
          <p className="text-red-800">Please register before starting quiz</p>
        </header>
        ...
        {userData? (
          ...
          // If no userData → show Register page
          <Register
            onSuccess={(user) => {
              setUserData({ ...user}); // mark logged in
              setScreen("welcome"); // go to Welcome screen
            }}
          />
        )}
      </div>
